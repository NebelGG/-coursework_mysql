SocialView
Курсовая работа по базам данных (GeekUniversity, факультет Data engineering)
...
Описание проекта
Проект на стыке социальной сети и упрощенной модель хранения данных сервиса IMDb,а так же акцентом на составление списков.
...
Самое интересное кроется в возможностях пользователя, которые в SociaView достаточно обширны.
...
Подписываться на ключевые слова – это что-то вроде меток 
